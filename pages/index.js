...
<section id="about" className="bg-white py-16 px-6 text-center">
  ...
  {/* Grid Layout: Left Texts – Center Image – Right Texts */}
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center justify-center">
    
    {/* Left Column */}
    <div className="space-y-8">
      <div className="flex items-start gap-4 text-left">
        <Image src="/icons/paw-red.png" alt="Real Food" width={30} height={30} />
        <div>
          <p className="font-bold text-gray-800">Real Food</p>
      ...
      <div className="flex items-start gap-4 text-left">
        <Image src="/icons/paw-green.png" alt="Made Fresh" width={30} height={30} />
        <div>
          <p className="font-bold text-gray-800">Made Fresh</p>
          <p className="text-sm text-gray-600">
    ...
    <div className="space-y-8">
      <div className="flex items-start gap-4 text-left">
        <Image src="/icons/paw-orange.png" alt="Premium Ingredient" width={30} height={30} />
        <div>
          <p className="font-bold text-gray-800">Premium Ingredient</p>
          <p className="text-sm text-gray-600">
      ...
      <div className="flex items-start gap-4 text-left">
        <Image src="/icons/paw-pink.png" alt="Vet Developed" width={30} height={30} />
        <div>
          <p className="font-bold text-gray-800">Vet Developed</p>
          <p className="text-sm text-gray-600">
